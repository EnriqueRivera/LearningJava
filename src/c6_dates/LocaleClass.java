...
public class LocaleClass {
    ...
    public static void main(String[] args) {
        ...
        //getDisplayCountry() and getDisplayLanguage())
        c = Calendar.getInstance();
        c.set(2010, 11, 14);
        d2 = c.getTime();
        locBR = new Locale("pt", "BR"); // Brazil
        Locale locDK = new Locale("da", "DK"); // Denmark
        locIT = new Locale("it", "IT"); // Italy
        ...
        System.out.println("D>I " + locDK.getDisplayLanguage(locIT));   //in Italy, the Danish language is called "danese".
    }
}
